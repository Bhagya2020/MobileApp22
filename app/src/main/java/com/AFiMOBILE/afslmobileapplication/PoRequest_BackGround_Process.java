...
public class PoRequest_BackGround_Process extends AsyncTask<String , String , String> {
    private Context mContex;
    private SqlliteCreateLeasing sqlliteCreateLeasing_PoDataRequest;
    private SQLiteDatabase sqLiteDatabase_PoData;
    private String PHP_URL_SQL,LoginUser,LoginDate,LoginBranch;
    private android.app.AlertDialog progressDialog;
    private String InputApplicationno , mData_Appno ,mData_SubProduct , mBranch , mMkOfficer , mDataCl_Nic , mData_FullyName , mData_Mobileno,
            mClNic, mData_Product,ApplicationJsonResponce,ApplicationJsonResponce_Image,FileUploadSts;
    private RequestQueue requestQueue_FileComplete;

    public PoRequest_BackGround_Process(Context context)
    {
        mContex =  context;
    ...
    protected void onPreExecute()
    {
        ...
        progressDialog.setTitle("Sending PO Request ...");
        progressDialog.setMessage("Please wait...");
        progressDialog.show();
    }

    @Override
    protected String doInBackground(String... mInpAppno) {

        InputApplicationno = mInpAppno[0];
        mData_Appno = mInpAppno[0];

        Log.e("appno" , InputApplicationno);
        ...
        Cursor mApplicationCurser = sqLiteDatabase_PoData.rawQuery("SELECT APPLICATION_REF_NO,AP_PRODUCT,AP_INVOICE_AMT,AP_DOWN_PAY,AP_FACILITY_AMT,AP_ETV,AP_RATE," +
                "AP_PERIOD,AP_RENTAL_AMT,AP_MK_OFFICER,AP_BRANCH,AP_PO_STS,AP_PO_SEND_DELEAR,AP_PO_DELEAR_EMAIL,AP_ENTDATE,AP_STAGE,AP_MAIN_SUPPLIR,AP_MAIN_SUPPLIR_EMAIL,AP_PO_RQ_USER FROM LE_APPLICATION WHERE APPLICATION_REF_NO = '" + InputApplicationno + "'", null);
        ...
        Cursor mClientCurser = sqLiteDatabase_PoData.rawQuery("SELECT APPLICATION_REF_NO,CL_NIC,CL_TITLE,CL_FULLY_NAME,CL_ADDERS_1" +
                ",CL_ADDERS_2,CL_ADDERS_3,CL_ADDERS_4,CL_OCCUPATION,CL_MOBILE_NO,CL_CREATE_DATE,CL_CREATE_USER,INCOME_SOURCE,CL_DATE_OF_BIRTH,CL_AGE,CL_EMARKS FROM LE_CLIENT_DATA WHERE APPLICATION_REF_NO = '" + InputApplicationno + "'", null);
        ...
        if (mClientCurser.getCount() != 0)
        {
            ...
            try {
                ...
                ApplicationClData.put("CL_EMARKS", mClientCurser.getString(15));
        ...
        Cursor cursorAsset = sqLiteDatabase_PoData.rawQuery("SELECT APPLICATION_REF_NO,AS_EQ_TYPE,AS_EQ_CATAGE,AS_EQ_MAKE,AS_EQ_MODEL,AS_EQ_REGNO,AS_EQ_ENG_NO,AS_EQ_CHAS_NO,AS_EQ_YEAR," +
                "AS_INV_DELER,AS_INV_SUPPLIER,AP_INV_DATE,AP_INSURANCE_COMPANY,AP_ENT_DATE,AP_ENT_USER,MK_VAL ,AP_INTDU,M_IND_CODE,M_SUP_CODE,M_DELEAR_CODE FROM LE_ASSET_DETAILS WHERE APPLICATION_REF_NO = '" + InputApplicationno + "'", null);
        ...
        //========= Create charges data  ===================
        //================================================
        Cursor cursorcharge = sqLiteDatabase_PoData.rawQuery("SELECT APPLICATION_REF_NO,OT_CHARGE_NAME,OT_CHARGE_AMT,OT_CHARGE_TYPE FROM LE_CHARGS WHERE APPLICATION_REF_NO = '" + InputApplicationno + "'", null);
        ...
        try {
            jsonObjectPorequest.put("APPLICATION_REF_NO" , InputApplicationno);
        ...
        JsonObjectRequest jsonObjectRequest_CompleteData = new JsonObjectRequest(Request.Method.POST, Urlapplication, jsonObject_FileComplete,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                String ErrorDescription="Responses Failure.(" + ErrorCode.toString() + ").Please try again..";
        ...
        try {
            jsonObject_data.put("APPLICATION_REF_NO" ,  InputApplicationno);
        ...
        //==== Create Json Request to live server  ========
        ...
        requestQueue_FileComplete.addRequestFinishedListener(new RequestQueue.RequestFinishedListener<Object>() {
            ...
            public void onRequestFinished(Request<Object> request)
            {
                ...
                if (ApplicationJsonResponce != null)
                {
                    ...
                    {
                        //===== Change Application status - Change the Submit application
                       sqlliteCreateLeasing_PoDataRequest.UpdateAppSts(InputApplicationno, "002" , "S");
                    }
                }
                ...
                if (CheckApplication==true && mCheck_Image==true)
                {
                    ...
                    if (CheckFileCommplete)
                    {
                        ...
                        if(!((Activity) mContex).isFinishing())
                        {
                            ...
                            builder_SUCESS.setMessage("Po Request Successfully. Please Check submit Application Menu to complete.");
